...
{
    $sql = "UPDATE `home_page` SET title='$_POST[title]',tagline='$_POST[tagline]',description='$_POST[description]' WHERE id=1 "; 
                ...
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Update Home Page</h4>
                            </div>
                            <div class="card-body">
                                <form action='' method='POST' >
                                    <div class="form-body">
                                    <?php $qml ="SELECT * from `home_page`";
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="tagline" value="<?php echo $roww['tagline'];?>" class="form-control form-control-danger" >
                                                    </div>
                                            </div>
                                            <!--/span-->
                                        </div>
