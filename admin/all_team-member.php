                                        ...
                                        <tbody>
												...
												$query=mysqli_query($link,$sql);
													...
													if(!mysqli_num_rows($query) > 0 )
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																				...
																				$fetch=mysqli_fetch_array($newquery);
																					...
																					echo '<tr><td>'.$rows['id'].'</td>
																								...
																								<center><img src="team/'.$rows['image'].'" class="img-responsive  radius" style="max-height:200px;max-width:250px;" /></center>
																								</div></td>
													 ...
													 <td><a href="delete_team-member.php?menu_del='.$rows['id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash" style="font-size:16px"></i></a> 

																			 <a href="update_team-member.php?speaker_upd='.$rows['id'].'" class="btn btn-success btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="ti-settings"></i></a>
																									</td></tr>';
