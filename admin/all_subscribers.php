...
<body class="fix-header fix-sidebar">
  ...
  if ( $connection_mysql->connect_errno ) {
   ...
   $sql = "SELECT * FROM rise_newsletter";
   
   if ($result = mysqli_query($connection_mysql,$sql)){
      $rowcount = mysqli_num_rows($result);
      
      printf("Total Sub's - %d \n",$rowcount);
											...
											<?php
												...
												$query=mysqli_query($link,$sql);
													...
													if(!mysqli_num_rows($query) > 0 )
														{
															echo '<td colspan="4"><center>No Orders-Data!</center></td>';
														}
													else
														{				
																	while($rows=mysqli_fetch_array($query))
																		{
																				...
																				<?php
                                                                                    ...
                                                                                    ?>
														<?php																	 					                                                                                        ?>
                                                                                        <td class="text-dark"><?php echo $rows['subscribed_at']?></td>
                                                                                        
																									 <td> 
                                                                                                     <a href="delete_subscriber.php?order_del=<?php echo $rows['id'];?>" onclick="return confirm('Are you sure?');" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash" style="font-size:16px"></i></a> 
																								<?php
																								echo '';
