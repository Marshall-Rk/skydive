	...
	else
		{
				...
				$fname = $_FILES['file']['name'];
					...
					{        
						...
						$sql = "INSERT INTO blog(name,heading,description,tags,image) VALUE('".$_POST['name']."','".$_POST['heading']."','".$_POST['description']."','".$_POST['tags']."','".$fnew."')";  // store the submited data ino the database :images
                ...
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Add Blog</h4>
                            </div>
                            <div class="card-body">
