...
if(isset($_POST['submit']))          
{
	...
	else
		{
				...
				$fname = $_FILES['file']['name'];
								...
								$fnew = $_POST['name'].'.'.uniqid().'.'.$extension;
   
								$store = "testimonial/".basename($fnew);                     
					...
					{        
						...
						$sql = "INSERT INTO testimonial(name,type,review,image) VALUE('".$_POST['name']."','".$_POST['type']."','".$_POST['review']."','".$fnew."')";  // store the submited data ino the database :images
                ...
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Add Testimonial</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="type" placeholder="Student or Customer" class="form-control" >
                                                   </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="review" value="" class="form-control" >
                                                   </div>
                                            </div>
