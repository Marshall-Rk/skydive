            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
						     ...
						     <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">All Joyride</h4>
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																				...
																				$fetch=mysqli_fetch_array($newquery);
																					...
																					echo '<tr><td>'.$rows['id'].'</td>
																								...
																								<center><img src="joyride/'.$rows['image'].'" class="img-responsive  radius" style="max-height:200px;max-width:250px;" /></center>
																								</div></td>

																						<td class="text-dark">'.$rows['description'].'</td>
                                                                                        <td class="text-dark">'.$rows['flight_time'].'</td>
																							<td class="text-dark">'.$rows['passenger_age'].'</td>
                                                                                            <td class="text-dark">'.$rows['passenger_weight'].'</td>

                                                                                            <td class="text-dark">'.$rows['price'].'</td>

                                                                                            <td class="text-dark">'.$rows['video_recording'].'</td>
                                                                                                <td class="text-dark">'.$rows['added_on'].'</td>
																								
																								
																								
																							
													 <td><a href="delete_joyride.php?menu_del='.$rows['id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash" style="font-size:16px"></i></a> 

																			 <a href="update_joyride.php?speaker_upd='.$rows['id'].'" class="btn btn-success btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="ti-settings"></i></a>
																									</td></tr>';
