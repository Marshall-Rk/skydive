...
if(isset($_POST['submit']))          
{
	...
	else
		{
            ...
            $sql = "UPDATE `team` SET name='$_POST[name]',designation='$_POST[designation]' WHERE id='$_GET[speaker_upd]'";  // update the submited data ino the database :images
...
{	
	...
	$folder = "team/".$_POST['name'].$filename;
      ...
      $sql = "UPDATE `team` SET image='$newname' WHERE id='$_GET[speaker_upd]'"; 
                        ...
                        <div class="card card-outline-primary">
                            ...
                            <div class="card-body">
                                <form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body">
                                        <?php $qml ="SELECT * from `team` where id='$_GET[speaker_upd]'";
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="designation" value="<?php echo $roww['designation'];?>" class="form-control form-control-danger" placeholder="slogan">
                                                    </div>
                                            </div>
                                            <!--/span-->
                                        </div>
