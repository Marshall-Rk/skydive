...
if(isset($_POST['submit']))          
{
		...
		if(empty($_POST['name'])||empty($_POST['type'])||empty($_POST['review']))
		{	
	...
	else
		{
            ...
            $sql = "UPDATE `testimonial` SET name='$_POST[name]',type='$_POST[type]',review='$_POST[review]' WHERE id='$_GET[speaker_upd]'";  // update the submited data ino the database :images
...
{	
	...
	$folder = "testimonial/".$_POST['name'].$filename;
      ...
      $sql = "UPDATE `testimonial` SET image='$newname' WHERE id='$_GET[speaker_upd]'"; 
                        ...
                        <div class="card card-outline-primary">
                            ...
                            <div class="card-body">
                                <form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body">
                                        <?php $qml ="SELECT * from `testimonial` where id='$_GET[speaker_upd]'";
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="type" value="<?php echo $roww['type'];?>" class="form-control form-control-danger" placeholder="slogan">
                                                    </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="<?php echo $roww['review'];?>" name="review" class="form-control" placeholder="₹">
                                                   </div>
                                            </div>
                                                                                       <!--/span-->
                                            <!--/span-->
