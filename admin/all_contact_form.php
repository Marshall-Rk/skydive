																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																				...
																				<?php
																					echo ' <tr>
                                                                                            <td class="text-dark">'.$rows['id'].'</td>
                                                                                            <td class="text-dark">'.$rows['first_name'].' '.$rows['last_name'].'</td>
                                                               
                                                               
                                                                <td class="text-dark">'.$rows['email'].'</td>
                                                                
                                                                                                                                <td class="text-dark">'.$rows['subject'].'</td>
																				        <td class="text-dark">'.$rows['message'].'</td>';
                                                                                    ?>
														<?php																	 					                                                                                        ?>
                                                                                        <td class="text-dark"><?php echo $rows['booked_at']?></td>
																									 <td> 
                                                               <a href="delete_contact_form.php?order_del=<?php echo $rows['id'];?>" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash" style="font-size:16px"></i></a> 
