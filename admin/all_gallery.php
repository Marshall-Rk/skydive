													...
													if(!mysqli_num_rows($query) > 0 )
														...
														{				
																	while($rows=mysqli_fetch_array($query))
																		{
																				$mql="SELECT * from `gallery`";
																				$newquery=mysqli_query($link,$mql);
																				$fetch=mysqli_fetch_array($newquery);

                                                          $orgDate = $rows['date'];
                                                      $newDate = date("F j, Y, g:i a", strtotime($orgDate));
																					...
																					echo '<tr><td>'.$rows['id'].'</td>
																								...
																								<center><img src="gallery/'.$rows['image'].'" class="img-responsive  radius" style="max-height:200px;max-width:250px;" /></center>
																								</div></td>


																					
                            <td class="text-dark">'.$newDate.'</td>
																								
																								
																								
																							
													 <td><a href="delete_gallery.php?menu_del='.$rows['id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash" style="font-size:16px"></i></a> 
