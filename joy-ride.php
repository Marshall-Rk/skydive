...
.elementor-heading-title{padding:0;margin:0;line-height:1}.elementor-widget-heading .elementor-heading-title[class*=elementor-size-]>a{color:inherit;font-size:inherit;line-height:inherit}.elementor-widget-heading .elementor-heading-title.elementor-size-small{font-size:15px}.elementor-widget-heading .elementor-heading-title.elementor-size-medium{font-size:19px}.elementor-widget-heading .elementor-heading-title.elementor-size-large{font-size:29px}.elementor-widget-heading .elementor-heading-title.elementor-size-xl{font-size:39px}.elementor-widget-heading .elementor-heading-title.elementor-size-xxl{font-size:59px}</style><h2 class="elementor-heading-title elementor-size-default">Paragliding Joyrides</h2>		</div>
				</div>
			...
			<link rel="stylesheet" href="wp-content/plugins/elementor/assets/css/widget-icon-list.min.css">		<ul class="elementor-icon-list-items elementor-inline-items">
							...
							<i aria-hidden="true" class="fas fa-chevron-right"></i>						</span>
										<span class="elementor-icon-list-text">Paragliding Joyrides</span>
									</li>
						</ul>
				</div>
				</div>
		...
		<div class="container" style="margin-top:20px;margin-bottom:20px;">
			<div class="row">
				<div class="col-md-12">
					<h2 style="font-weight:700;color:#31A4DA;">Paragliding Flight at Bir Himachel. Fly like a bird...without learning to fly
</h2>
					<h3 style="font-size:22px;">Tandem Paragliding flight - Paragliding ride at Bir Himachel</h3>
					<p style="color:#282828;text-align:justify;">If you want to try your hand at paragliding but don’t want to commit to learning the sport , paragliding flight or paragliding joyrides (tandem paragliding) are the perfect option!
Soar high in the sky with one of our experienced pilots at one of our 3 nearby sites. The Pilots will do all the work, all you have to do is sit back, relax and enjoy the ride of a lifetime!</p>
				</div>
			...
			<div class="row">
				<div class="col-md-12">
					<h2 style="font-size:22px;">What is Tandem Paragliding flight?</h2>
				
					<p style="color:#282828;text-align:justify;">Paragliding flight (joyride) or Tandem Paragliding is the easiest and safest way for absolutely anybody and everybody to experience the joy of the skies. You do not need to learn to fly, no prior experience needed at all. Tandem paragliders have larger wings than solo gliders so that they can comfortably accommodate both the pilot and his passenger.
...
<?php 
						...
						$query_res= mysqli_query($link,"SELECT * from `joyride` ORDER BY `added_on` ASC"); 
...
<div class="row" >
<div class="col-md-7">		
<h2 style="font-weight:bold;color:#31A4DA;margin-top:20px;">'.$r['heading'].'</h2>
<p style="color:#282828;text-align:justify;">'.$r['description'].'</p>
<h2 style="font-size:21px;font-weight:200;"><i class="fas fa-clock"></i> Flight Duration: '.$r['flight_time'].'</h2>
<h2 style="font-size:21px;font-weight:200;"><i class="fas fa-user"></i> Passenger Age: '.$r['passenger_age'].'</h2>
<h2 style="font-size:21px;font-weight:200;"><i class="fas fa-weight-hanging"></i> Passenger Weight: '.$r['passenger_weight'].'</h2>
<h2 style="font-size:21px;font-weight:200;"><i class="fas fa-rupee"></i> Flight Cost: '.$r['price'].'</h2>
<h2 style="font-size:21px;font-weight:200;"><i class="fas fa-video-camera"></i> Flight Video: '.$r['video_recording'].'</h2>
<div class="jeg-elementor-kit jkit-button  icon-position-after jeg_module_9_1_6375fcdbd0914"><a href="contact-us/index.php" style="background-color:#31A4DA;" class="jkit-button-wrapper">REGISTER NOW</a></div>
</div>
<div class="col-md-5" style="float:right;margin-top:20px;">
<img src="admin/joyride/'.$r['image'].'"  style="float:left;margin-top:10px;" alt="">
</div>
</div>
<hr>
